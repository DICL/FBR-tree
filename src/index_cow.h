...
extern int RTreeCoWAddBranch(PMEMobjpool *, struct Branch *, TOID(Node), TOID(Node)*, TOID(Node)*, TOID(Node), TOID(splitLog));
extern int RTreeCoWAddTwoBranches(PMEMobjpool *, struct Branch *, struct Branch *, TOID(Node), TOID(Node)*, TOID(Node)*, TOID(Node), TOID(splitLog));
