...
//----- Function prototypes -------------------------------------------------
unsigned long long poisson(double x);       // Returns a Poisson random variable
...
//===========================================================================
unsigned long long  poisson(double x)
{
  unsigned long long  poi_value;             // Computed Poisson value to be returned
